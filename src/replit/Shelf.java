...
public class Shelf {
    ...
    private static List<Book> byTheAuthor= new ArrayList<>();


    public static void setTheBooks( List<Book> theBooks ) {
        Shelf.theBooks = theBooks;
    }



    public static void setByTheAuthor( List<Book> byTheAuthor ) {
        Shelf.byTheAuthor = byTheAuthor;
    }

    public static List<Book> getByTheAuthor() {
        return byTheAuthor;
    }
    ...
    public static Book findBookByPartialTitle(String title) {
        ...
        for (int i = 0;i < theBooks.size();i++) {
            String title1 = theBooks.get(i).getTitle();
    ...
    public static void removeBook(String author) {
        ...
        theBooks.clear();
        for (int i=0; i < byTheAuthor.size(); i++){

            theBooks.add(byTheAuthor.get(i));
        }
